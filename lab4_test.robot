#ภคพล อยู่ยืน 663380226-7 Sec.1

*** Settings ***
Library    SeleniumLibrary

*** Variables ***
${SERVER}    http://127.0.0.1:5500/StarterFiles
${HOMEPAGE}    https://www.google.com
${BROWSER}    Chrome
${REG_URL}    ${SERVER}/Registration.html
${SUC_URL}    ${SERVER}/Success.html
